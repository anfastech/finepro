...
def upgrade() -> None:
    ...
    sa.Column('appwrite_id', sa.String(length=255), nullable=False),
    ...
    op.create_index(op.f('ix_users_appwrite_id'), 'users', ['appwrite_id'], unique=True)
    ...
    sa.Column('entity_type', sa.Enum('TASK', 'EPIC', 'PROJECT', 'WORKSPACE', 'USER', name='entitytype'), nullable=False),
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('appwrite_id', sa.String(length=255), nullable=True),
    ...
    op.create_index(op.f('ix_workspaces_appwrite_id'), 'workspaces', ['appwrite_id'], unique=True)
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('task_type', sa.Enum('FRONTEND', 'BACKEND', 'DESIGN', 'TESTING', 'DEVOPS', 'DOCUMENTATION', name='tasktype'), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_workspaces_appwrite_id'), table_name='workspaces')
    op.drop_table('workspaces')
    op.drop_table('activity_logs')
    op.drop_index(op.f('ix_users_email'), table_name='users')
    op.drop_index(op.f('ix_users_appwrite_id'), table_name='users')
    op.drop_table('users')
    # ### end Alembic commands ###
